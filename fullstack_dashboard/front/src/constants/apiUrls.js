...
const GET_VOLUME_SERVICE_API_URL = `${domain}/volume_services`;

export { GET_VISITORS_API_URL, GET_REVENUE_API_URL, GET_CUSTOMER_API_URL, GET_TARGET_REALITY_API_URL, GET_TOP_PRODUCT_API_URL, GET_SALES_MAP_API_URL, GET_VOLUME_SERVICE_API_URL, REST_COUNTRIES_API_URL };